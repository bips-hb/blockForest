...
public:
  ...
  void initR(std::string dependent_variable_name, Data* input_data, std::vector<uint>& mtry, uint num_trees,
  ...
  const std::vector<uint>& getMtry() const {
    return mtry;
  }
