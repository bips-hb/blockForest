...
bool TreeClassification::splitNodeInternal(size_t nodeID, std::vector<std::vector<size_t>>& possible_split_varIDs) {
...
bool TreeClassification::findBestSplit(size_t nodeID, std::vector<std::vector<size_t>>& possible_split_varIDs) {
...
bool TreeClassification::findBestSplitExtraTrees(size_t nodeID,
